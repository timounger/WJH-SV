...
*****************************************************************************
 ...
 @brief   WJH-SV - Utility Script to list and check if the build executable only
...
S_RELATIVE_PATH = r'build\WJH-SV\xref-WJH-SV.html'
...
if __name__ == "__main__":
	...
	regex_own_packs = re.compile(r"WJH-SV\/.*")
